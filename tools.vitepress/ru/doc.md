---
title: Теория вероятностей в действии
...
### Взаимосвязи и иерархии задач (Jobs)
Задачи могут быть связаны между собой, образуя иерархические структуры, где родительские задачи представляют собой проекты, содержащие дочерние задачи в качестве подзадач.
...
::: details Проект масштабируем?
Анализ от [DeepWiki](https://deepwiki.com/pravosleva/team-scoring-2024/1-overview)
...
Параллельная обработка с помощью веб-воркеров
Приложение использует несколько выделенных веб-воркеров для разгрузки ресурсоемких вычислений от основного потока:
