...
- [Оригинал ↗️](https://www.joelonsoftware.com/2007/10/26/evidence-based-scheduling/)
- [Перевод на русский ↗️](https://habr.com/ru/articles/186410/)
:::
...
1. Расчет затраченных бизнес-часов, потраченных на задачу (или группу задач). В заданном формате нужно указать рабочие часы (поле `_descr` является опциональным);
