    ...
    switch (e.data.__eType) {
      ...
      default: {
        ...
        if (!!input?.opsEventType) {
          ...
          // console.log(NES.Common.ClientService.PointsetTreeCalc.EClientToWorkerEvent.GET_POINTSET_TREE_CALC)
          ...
          withRootMW({
            ...
            cb: {
              [NES.Common.ClientService.PointsetTreeCalc.EClientToWorkerEvent.GET_POINTSET_TREE_CALC]: ({
                ...
                if (debugConfig.workerEvs.fromClient.isEnabled) log({
                  label: `Dedicated Worker: Вызван обработчик withRootMW -> cb[${NES.Common.ClientService.PointsetTreeCalc.EClientToWorkerEvent.GET_POINTSET_TREE_CALC}]`,
